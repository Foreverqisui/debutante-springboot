...
<style>
HTML CSS Result Skip Results Iframe html,
body {
  width: 100%;
  height: 100%;
}
...
.beard {
  ...
  box-shadow: 15px 40px 0 -5px #fff, 35px 40px 0 -3px #fff,
    20px -15px 0 0px #fff;
}
...
@keyframes arm-anim {
  ...
  30% {
    ...
    border: none;
    box-shadow: -2px 10px 0 -3px #fff, -20px 8px 0 0 #b03331 inset,
      -20px -10px 0 0 #b03331 inset, -20px 15px 0 0 #b03331 inset;
  }
...
.stomach {
  ...
  bottom: -25px;
  z-index: -1;
  box-shadow: -10px -4px 0 0 #da4642 inset, -20px -4px 0 0 #000 inset,
    -10px -4px 0 0 #fff inset;
}
...
.christmas-tree-white .tree-top4,
.christmas-tree-white .tree-top3,
.christmas-tree-white .tree-top2,
.christmas-tree-white .tree-top1 {
  background-color: #fff;
}
...
.gift--orange .gift-top,
.gift--orange .gift-bottom {
  background-color: orange;
}
</style>